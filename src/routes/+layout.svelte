...
<div class="w-screen h-screen flex flex-col bg-gradient-to-br from-neutral to-neutral dark:to-base-300/90 overflow-hidden min-w-[280px]">
	<nav class="navbar min-w-max gap-x-3">
		<div class="navbar-start">
			<div class="dropdown">
				...
				<ul tabindex="-1" class="menu menu-sm dropdown-content bg-base-100 dark:bg-base-200 rounded-box z-1 mt-3 w-52 p-2 shadow">
					<li><a href="{resolve('/')}" class="link text-accent hover:text-secondary text-lg font-bold transition-transform duration-200 hover:scale-105">About Me</a></li>
					...
					<li><button class="btn btn-sm btn-accent border-0 hover:btn-secondary" onclick={openCredsPopUp}>Enter Credentials</button></li>
				</ul>
			</div>
			<a class="btn border-0 text-xl h-full bg-transparent w-22 md:w-30 transition-transform duration-200 hover:scale-105" href="{resolve('/')}">
		...
		<div class="navbar-center hidden lg:flex">
			<ul class="menu menu-horizontal px-1 gap-x-3">
				...
				<a href="{resolve('/')}" class="link text-primary hover:text-secondary text-lg font-bold transition-transform duration-200 hover:scale-105">About Me</a>
		...
		<div class="navbar-end gap-x-3">
			<button class="btn btn-primary border-0 hover:bg-secondary hidden lg:inline" onclick={openCredsPopUp}>Enter Credentials</button>
